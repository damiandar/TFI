<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="Contratos.aspx.vb" Inherits="aplicacion_forms" %>
...
<div class="row">
    ...
    <div role="form">
     <div class="form-group input-group">
            ...
            <span class="input-group-btn">
                <asp:LinkButton class="btn btn-default" ID="btnBuscar" runat="server">
                <i class="fa fa-search"></i>
                </asp:LinkButton>   
                <asp:LinkButton class="btn btn-default" ID="btnNuevo" runat="server">
                <i class="fa fa-search"></i>
                </asp:LinkButton>      
            </span>
    </div>
    ...
    <asp:GridView ID="GrillaContratos" runat="server">
    <Columns>
    <asp:TemplateField HeaderText="Cliente">      
    <ItemTemplate>
        <asp:Label ID="lblCuenta" runat="server" Text='<%#Eval("cuenta.razon") %>' ></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Servicio">      
    <ItemTemplate>
        <asp:Label ID="lblServicio" runat="server" Text='<%#Eval("servicio.descripcion") %>' ></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    </Columns>
    </asp:GridView>
    ...
    <div  class="col-lg-6">
     ...
     <div class="form-group">
        <label>Servicio</label>
         <asp:DropDownList CssClass="form-control" ID="comboServicio" runat="server">
         </asp:DropDownList>
     </div>
     <div class="form-group">
        <label>Cliente</label>
        <asp:DropDownList CssClass="form-control" ID="comboCliente"  runat="server">
        </asp:DropDownList>
