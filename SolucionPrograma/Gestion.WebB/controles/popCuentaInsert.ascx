<%@ Control Language="VB" AutoEventWireup="false" CodeFile="popCuentaInsert.ascx.vb" Inherits="controles_popCuentaInsert" %>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <div class="pull-right">
                ...
                <asp:Button ID="btnGuardar" runat="server"  class="btn btn-primary" Text="Guardar" cssclass="btn btn-primary" />
              </div>
            </div>
          </div>
