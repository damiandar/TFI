...
(function($) {
  ...
  Sexy = {
    ...
    messageBox: function(type, message, properties, input) {
        ...
        if(type == 'alert' || type == 'info' || type == 'error' || type == 'time' || type == 'borrar')
        {
    ...
    */		
    ...
    time: function(message, properties){
      this.messageBox('time', message, properties);
    },
	
	borrar: function(message, properties){
    this.messageBox('borrar', message, properties);
    },
